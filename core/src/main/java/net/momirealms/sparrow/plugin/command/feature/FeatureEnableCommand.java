...
public final class FeatureEnableCommand extends BukkitCommandFeature {

    public FeatureEnableCommand(@NotNull CommandManager commandManager, @NotNull SparrowPlugin plugin) {
    ...
    private void execute(CommandContext<CommandSender> context) {
        ...
        try {
            manager.setEnabled(id, true).whenComplete((state, error) -> this.complete(context, id, state, error));
